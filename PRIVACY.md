...
**Note :** Ces actions n'ont _pas_ d'impact sur les données traitées par votre provider IA (Mistral AI, OpenAI, ou service personnalisé). Elles concernent uniquement la mémoire _locale_ de votre ordinateur.
