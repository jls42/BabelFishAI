...
(function (exports) {
     ...
     */
    function showBanner(banner, text, type = MESSAGE_TYPES.INFO, isRecording = false, updateColorCallback = null) { // skipcq: JS-0128 - Fonction conservée pour usage interne potentiel
     ...
     */
    function hideBanner(banner) { // skipcq: JS-0128 - Fonction conservée pour usage interne potentiel
        try {
            // Vérifier si la bannière existe
            if (!banner) {
                return false;
